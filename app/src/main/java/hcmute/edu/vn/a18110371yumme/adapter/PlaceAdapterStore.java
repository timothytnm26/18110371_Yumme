...
import hcmute.edu.vn.a18110371yumme.models.Place;

public class PlaceAdapterStore extends RecyclerView.Adapter<PlaceAdapterStore.ItemHolder>{

    private List<Place> mPlaces = new ArrayList<>();
    private Context context;
    private OnPlaceClickListener mListener;

    public PlaceAdapterStore() {
    ...
    public PlaceAdapterStore(Context context){
    ...
    public void onBindViewHolder(@NonNull final ItemHolder holder, int position) {
        ...
        if (holder.mItem.isFavorite()) {
            holder.icFavorite.setImageResource(R.drawable.icon_star);
        } else {
            holder.icFavorite.setImageResource(R.drawable.icon_star0);
        }
